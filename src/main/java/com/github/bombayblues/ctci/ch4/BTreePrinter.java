...
public class BTreePrinter {
    ...
    public static <T extends Comparable<?>> void printNode(final BTreeNode root) {
    ...
    private static <T extends Comparable<?>> void printNodeInternal(final List<BTreeNode> nodes, final int level, final int maxLevel) {
        ...
        final List<BTreeNode> newNodes = new ArrayList<BTreeNode>();
        for (final BTreeNode node : nodes) {
            if (node != null) {
    ...
    private static <T extends Comparable<?>> int maxLevel(final BTreeNode node) {
        if (node == null)
            return 0;
